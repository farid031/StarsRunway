...
public class CreateResultActivity extends AppCompatActivity {
    ...
    Button addBtn;
    String tanggal, jam, latitude, longitude, status, kodeToko, ket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextTanggal  = findViewById(R.id.result_textTanggal);
        TextJam      = findViewById(R.id.result_textJam);
        TextLatitude = findViewById(R.id.result_textLatitude);
        TextLongitude = findViewById(R.id.result_textLongitude);
        EditKodeToko = findViewById(R.id.result_editKodeToko);
        TextStatus   = findViewById(R.id.result_textStatus);
        TextStatus   = findViewById(R.id.result_textStatus);
        EditKet      = findViewById(R.id.result_editKet);
        addBtn       = findViewById(R.id.buttonAdd_Result);
    ...
    private void addData() {
        ...
        class CreateTask extends AsyncTask<String, String, String> {
            ...
            protected String doInBackground(String... strings) {
                ...
                return rh.sendPostRequest(Konfigurasi.URL_INSERT_RESULT, params);
            }

            @Override
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(CreateResultActivity.this, "Menambahkan...", "Tunggu...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(CreateResultActivity.this, s, Toast.LENGTH_LONG).show();
            }
        }
