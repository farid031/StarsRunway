...
public class ViewdataInActivity extends AppCompatActivity implements View.OnClickListener {

    private String v_id, tanggal, jam, latitude, longitude, status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_data_in);
    ...
    void tampil(){
        ...
        startActivity(new Intent(ViewdataInActivity.this, ReadInActivity.class));
    }
}
