...
public class ReadGoSamplingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_go_sampling);

        list = (ListView) findViewById(R.id.listview_gosampling);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int urutan, long id) {
                ...
                String id_s = ((TextView) view.findViewById(R.id.go_id)).getText().toString();
                String tanggal = ((TextView) view.findViewById(R.id.go_tanggal)).getText().toString();
                String jam = ((TextView) view.findViewById(R.id.go_jam)).getText().toString();
                String latitude = ((TextView) view.findViewById(R.id.go_latitude)).getText().toString();
                String longitude = ((TextView) view.findViewById(R.id.go_longitude)).getText().toString();
                String kodetoko= ((TextView) view.findViewById(R.id.go_kd_toko)).getText().toString();
                String kodestatus = ((TextView) view.findViewById(R.id.go_status)).getText().toString();
                String ket = ((TextView) view.findViewById(R.id.go_ket)).getText().toString();
                String kodeasm= ((TextView) view.findViewById(R.id.go_kd_asm)).getText().toString();
                ...
                Intent i = null;
                i = new Intent(ReadGoSamplingActivity.this, ViewDataGoSamplingActivity.class);
                Bundle b = new Bundle();
                //b.putString("id", id_m);
    ...
    class ReadDataTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ReadGoSamplingActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equalsIgnoreCase("Exception Caught")){
                Toast.makeText(ReadGoSamplingActivity.this, "Unable to connect to server,please check your internet connection!", Toast.LENGTH_LONG).show();
            }
            if(result.equalsIgnoreCase("no results")){
                Toast.makeText(ReadGoSamplingActivity.this, "Data empty", Toast.LENGTH_LONG).show();
            }else {
                list.setAdapter(new GoSamplingAdapter(ReadGoSamplingActivity.this,daftar_sampling)); //Adapter menampilkan data ke dalam listView
            }
        }
        ...
        String getDataList(){
            ...
            try {
                JSONObject json = jParser.makeHttpRequest(Konfigurasi.URL_READ_GOSAMPLING,"POST", parameter);
                ...
                if (success == 1) { //Ada record Data (SUCCESS = 1)
                    ...
                    for (int i = 0; i < daftarSampling.length() ; i++){
                        ...
                        tempSampling.setKet(c.getString(Konfigurasi.TAG_KET));
