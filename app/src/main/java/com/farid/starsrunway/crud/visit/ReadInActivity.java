...
public class ReadInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_invisit);

        list = (ListView) findViewById(R.id.listview_visit);
    ...
    class ReadDataTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ReadInActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equalsIgnoreCase("Exception Caught")){
                Toast.makeText(ReadInActivity.this, "Unable to connect to server,please check your internet connection!", Toast.LENGTH_LONG).show();
            }
            if(result.equalsIgnoreCase("no results")){
                Toast.makeText(ReadInActivity.this, "Data empty", Toast.LENGTH_LONG).show();
            }else {
                list.setAdapter(new VisitAdapter(ReadInActivity.this,daftar_visit)); //Adapter menampilkan data mahasiswa ke dalam listView
            }
        }
        ...
        String getDataList(){
            ...
            try {
                JSONObject json = jParser.makeHttpRequest(Konfigurasi.URL_READ_INVISIT,"POST", parameter);
