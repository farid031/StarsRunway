...
public class VisitOutAdapter extends BaseAdapter {
    ...
    public VisitOutAdapter(Activity a, ArrayList<Visit> d) {
        activity = a;
        data_visit = d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            ...
            TextView keterangan = vi.findViewById(R.id.ket);
            ...
            keterangan.setText(daftar_vst.getKet());
